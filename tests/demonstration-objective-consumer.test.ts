...
test("D5 rejects a tampered D4 input projection",()=>{
 ...
 bad.requirements.find(r=>r.requirement_id==="R-GAP")!.fit_state="ESTABLISHED";
 assert.throws(()=>buildDemonstrationObjectiveConsumerProjection(bad,d2,d3,l),/D4.*(invalid|diverge|deterministic)|fit state|D2/i);
});
