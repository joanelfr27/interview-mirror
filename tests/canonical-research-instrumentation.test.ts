...
test("D10 rejects invalid event dimensions",()=>{const v=validateCanonicalResearchEvent({event_id:"e1",session_id:"s1",event_name:"PROBE_ROUTE_SELECTED",occurred_at:"2026-09-23T00:00:00Z",probe_mode:"NOT_A_REAL_MODE"});assert.equal(v.valid,false);});
